...
m_processor(processor), m_window(new CamomileEditorWindow())
{
    ...
    setAlwaysOnTop(true);
    //m_center.setImage(ImageCache::getFromMemory(BinaryData::terminal_png, BinaryData::terminal_pngSize));
    m_petals.setImage(ImageCache::getFromMemory(BinaryData::terminal_png, BinaryData::terminal_pngSize));
    //m_center.setTransformToFit(juce::Rectangle<float>(0.f, 0.f, 30.f, 30.f), RectanglePlacement::stretchToFit);
    m_petals.setTransformToFit(juce::Rectangle<float>(0.f, 0.f, 24.f, 24.f), RectanglePlacement::stretchToFit);
